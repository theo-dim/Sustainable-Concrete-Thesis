"""
===============================================================
G(r) Isotonic Regression for High-Alkali, S-Activated Metakaolin
===============================================================
"""
...
main = pd.read_csv('/Users/Theo/Google Drive/College/Senior Thesis/Materials Science/data/isotonic/hasam_g.csv', sep=',',names = ['Time','G'])
