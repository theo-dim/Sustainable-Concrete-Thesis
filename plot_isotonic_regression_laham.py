"""
===============================================================
G(r) Isotonic Regression for Low-Alkali, H-Activated Metakaolin
===============================================================
"""
...
main = pd.read_csv('/Users/Theo/Google Drive/College/Senior Thesis/Materials Science/data/isotonic/laham_g.csv', sep=',',names = ['Time','G'])
